...
APP_SEQUENCE = ['cartelpractice', 'cartelgame']
NUM_DEMO_PARTICIPANTS = 4

SESSION_CONFIGS = [
    {
        'name': 'pcc_baseline1',
        'display_name': 'Cartel Game - Baseline 1',
    ...
    {
        'name': 'pcc_immunity',
        'display_name': 'Cartel Game - Immunity',
        'num_demo_participants': NUM_DEMO_PARTICIPANTS,
        'app_sequence': APP_SEQUENCE,
        'treatment': 'immunity',
        ...
        'chat_penalty_percentage': 50,
        'chat_detection_chance': 15,
        'criminal_case_chance': 0,
    },
    {
        'name': 'pcc_leniency1',
        'display_name': 'Cartel Game - Leniency 1',
        'num_demo_participants': NUM_DEMO_PARTICIPANTS,
        'app_sequence': APP_SEQUENCE,
        'treatment': 'leniency1',
        ...
        'has_random_detection': True,
        'has_previous_round_detection': False,
        'reduced_chat_penalty_percentage': 80,
        'chat_penalty_percentage': 50,
        'chat_detection_chance': 15,
        'criminal_case_chance': 0,
    },
    {
        'name': 'pcc_settlement1',
        'display_name': 'Cartel Game - Settlement 1',
        'num_demo_participants': NUM_DEMO_PARTICIPANTS,
        'app_sequence': APP_SEQUENCE,
        'treatment': 'settlement1',
        ...
        'has_random_detection': True,
        'has_previous_round_detection': False,
        'reduced_chat_penalty_percentage': 50,
        'chat_penalty_percentage': 50,
        'chat_detection_chance': 30,
        'criminal_case_chance': 0,
    },
]
